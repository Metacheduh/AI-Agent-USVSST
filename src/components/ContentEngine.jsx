...
{JSON.stringify(generatedContent.verifiedData, null, 2)}
          ...
          <div style={{ gridColumn: 'span 2', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '4rem 2rem', textAlign: 'center' }}>
            <Mail size={40} style={{ marginBottom: '1rem', color: 'var(--text-tertiary)', opacity: 0.5 }} />
            <h3 style={{ margin: 0, fontSize: '1.1rem', fontWeight: 500, color: 'var(--text-secondary)' }}>No Content Generated Yet</h3>
            <p style={{ margin: '0.75rem 0 1.5rem', maxWidth: '480px', lineHeight: 1.6, fontSize: '0.9rem', color: 'var(--text-tertiary)' }}>
              Click <strong>"Force Generation Run"</strong> above to run the IntelScout evaluator and generate
              lawyer emails, beneficiary newsletters, blog posts, and social media alerts from live intelligence data.
            </p>
